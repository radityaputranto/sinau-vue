...
<script>
    ...
    /* Penjelasan: this.$store cara untuk mengakses store dari vuex, sedangkan setelahnya, 
    dalam hal ini state.listAgenda adalah bagian yang akan diakses dari store. */
</script>
